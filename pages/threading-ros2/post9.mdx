...
<Callout emoji="👾">
  Recommend to read [previous article](https://motion-boseong.vercel.app/post8).
  All the publisher and subscription system is the same, and I will not explain
  them here.
</Callout>

In the [previous article](https://motion-boseong.vercel.app/post8), I wrote
...
[scenario](https://motion-boseong.vercel.app/post8#system-description) is
