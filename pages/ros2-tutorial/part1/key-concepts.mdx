...
- Publisher (sender of message stream): transmits data on a specific topic
  without concerning itself with whether the data is received by the intended
  recipients.
- Subscribers (receivers of message stream): registers interest in a particular
