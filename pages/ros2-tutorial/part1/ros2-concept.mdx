...
Regardless of ROS development, there already existed a well-established
communication protocol known as
[DDS](https://design.ros2.org/articles/ros_on_dds.html). ROS2 serves as a
C++/Python wrapper for this middleware, offering a straightforward
