...
1. **Concise**: This tutorial will provide you with essential design patterns
   and concepts at the beginner level, ensuring you learn precisely what you
   need without overwhelming you with unnecessary information.
2. **Coherent**: Unlike the official tutorial, this guide presents information
   in a clear and organized manner. Concepts and demos are logically structured,
...
3. **Comprehensive**: The official document contains too simple programs. This
   ...
   through the use of the latest tools (e.g., ignition gazebo, foxglov) and other new packages. By completing
