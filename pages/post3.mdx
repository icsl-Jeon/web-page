...
during code completion. But actually, this is not a good idea.
...
be built correctly. The reason is simple. Success of building process does have
...
## Setup CMake extension for configure, build, and install
