...
To align various user preferences, I have experiences apply reinforcement techniques  such as [AlighProp](https://github.com/mihirp1998/AlignProp).
...
#### On-device Model for Generative Edit of Galaxy 
- I am responsible for training the main models and improvement  in the diffusion schedulers.

#### Personal
- Virtual influencer with face swap and dreambooth LoRA with Flux.dev ([link](https://www.instagram.com/geni.baek.art/)) 
