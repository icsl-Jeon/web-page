...
In my team, I am working on inpainting / outpainting *on-device* model, providing clean removal without unwanted object generation even in tight masks.
Also, shadow removal is provided in the single model.
...
<Image
  src={"/images/bio/objectremoval.png"}
  width={1000}
  height={1000}
...
Especially, I frequently modify [their pipes](https://huggingface.co/docs/diffusers/api/pipelines/overview) to manipulate denoising steps. 


#### Adaptation from Large Foundation Models for On-Device Applications
I am mainly concerned with on-device application with strict limitations on ROM, peak memory, NPU evaluations, even in the model sizes.
...
### 2. Control of Diffusion Models  ✏️

#### Textual Inversion (Prompt Optimization)
[Related tech. report](https://arxiv.org/pdf/2503.04268).
Based on the prompt optimization, I compress abstract user intentions (they often do not have an idea on how to put into textual prompts 😼) into embedding spaces, by curating and training models with a good examples.  
...
<Image
  src={"/images/bio/textual-inversion.png"}
  width={800}
  height={800}
  className="mx-auto my-5"
/>
...
To align various user preferences, I have experiences apply reward-finetuning and reinforcement for non-differentiable rewards. 
...
<Accordion title="⚔️ Skills" isInitialOpen={false}>
<div>
✅You can click the links on images for relevant codes.
Other skills can be found in the above section 😊
...
<div className="p-2">
<ImageGrid data={skills_ml} linkOn={true} border={true} ></ImageGrid>
</div>
</div>
...
#### On-device Model for [*Generative Edit* (Galaxy S25)](https://www.linkedin.com/feed/update/urn:li:activity:7288177861780217856/)
...
### Personal Projects
- Virtual influencer with face swap and dreambooth LoRA with Flux.dev ([instalink](https://www.instagram.com/geni.baek.art/), [huggingfacePR](https://github.com/huggingface/diffusers/pull/9565?notification_referrer_id=NT_kwDOAcq3irQxMjY2MzAyOTQyNDozMDA2MjQ3NA&notifications_query=reason%3Aparticipating#issuecomment-2451286211)) 
- Motion diffusion models ([paper under review](https://arxiv.org/pdf/2503.02577)) 
</div>
</Accordion>
